...
public class LoginStepDefs extends MasterStepDefs {
	...
	@When("^I login using the username \"([^\"]*)\" and the password \"([^\"]*)\"$")
	public void i_login_using_the_username_and_the_password(String userName, String password) throws Throwable {
		//login(userName, password);
		loginPage.login(userName, password);
	}
