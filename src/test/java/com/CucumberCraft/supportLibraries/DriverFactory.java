...
public class DriverFactory {
	...
	public static AppiumDriver createInstance(SeleniumTestParameters testParameters) {
		...
		try {
			...
			case MINT:
				...
				driver = MintDriverFactory.getmintAppiumDriver(testParameters.getMobileExecutionPlatform(),
						testParameters.getDeviceName(), mobileProperties.getProperty("mintHost"),
	...
	public static RecheckDriver createInstanceWebDriver(SeleniumTestParameters testParameters) {
		...
		try {
			...
			case SAUCELABS:
				/*
				 * driver =
				 * SauceLabsDriverFactory.getSauceRemoteWebDriver(mobileProperties.getProperty(
				 * "SauceHost"), testParameters.getBrowser(),
				 * testParameters.getBrowserVersion(), testParameters.getPlatform(),
				 * testParameters);
				 */
				break;
	...
	/*
	  ...
	  driver = SeeTestDriverFactory .getSeeTestDriver(
